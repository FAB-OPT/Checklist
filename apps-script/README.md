...
| ② สรุปตามรอบ | **11:30** (เปิด) และ **22:00** (ปิด) | สาขาที่ยังไม่ส่ง + สาขาที่มีข้อไม่ผ่าน (พร้อมรายละเอียด) |
...
6. รัน `setupTriggers()` หนึ่งครั้ง (กดอนุญาตสิทธิ์) → สร้างทริกเกอร์ 11:30 และ 22:00 อัตโนมัติ
